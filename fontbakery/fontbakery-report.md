...
<details><summary>[17] QalamBadi[wght].ttf</summary>
<div>
<details>
...
acutecomb (U+0301), dotbelowcomb (U+0323), gravecomb (U+0300), hookabovecomb (U+0309), tildecomb (U+0303), uni0302 (U+0302), uni0304 (U+0304), uni0306 (U+0306), uni0307 (U+0307), uni0308 (U+0308), uni030A (U+030A), uni030B (U+030B), uni030C (U+030C), uni030F (U+030F), uni0311 (U+0311), uni0312 (U+0312), uni031B (U+031B), uni0326 (U+0326), uni0327 (U+0327), uni0328 (U+0328), uni032E (U+032E), uni032F (U+032F), uni0330 (U+0330), uni0331 (U+0331), uni0332 (U+0332), uni034F (U+034F), uni0483 (U+0483), uni0484 (U+0484), uni0485 (U+0485), uni0486 (U+0486), uni0488 (U+0488), uni0489 (U+0489), uniFE00 (U+FE00), uniFE01 (U+FE01), uniFE02 (U+FE02), uniFE03 (U+FE03), uniFE04 (U+FE04), uniFE05 (U+FE05), uniFE06 (U+FE06), uniFE07 (U+FE07), uniFE08 (U+FE08), uniFE09 (U+FE09), uniFE0A (U+FE0A), uniFE0B (U+FE0B), uniFE0C (U+FE0C), uniFE0D (U+FE0D), uniFE0E (U+FE0E) and uniFE0F (U+FE0F)</p>
 [code: mark-chars]
...
acute.case (unencoded), breve.case (unencoded), caron.case (unencoded), circumflex.case (unencoded), dieresis.case (unencoded), dotaccent.case (unencoded), grave.case (unencoded), hungarumlaut.case (unencoded), macron.case (unencoded), ring.case (unencoded) and tilde.case (unencoded)</p>
...
* uni0770.init: B&lt;&lt;124.0,727.5&gt;-&lt;124.0,727.0&gt;-&lt;124.0,727.0&gt;&gt; has the same coordinates as a previous segment.

* uni0770.init: B&lt;&lt;106.0,968.0&gt;-&lt;106.0,968.0&gt;-&lt;106.0,968.0&gt;&gt; has the same coordinates as a previous segment.

* uni0770.init: B&lt;&lt;106.0,968.0&gt;-&lt;106.0,968.0&gt;-&lt;106.0,968.0&gt;&gt; has the same coordinates as a previous segment.

* uni0770.init: B&lt;&lt;106.0,968.0&gt;-&lt;106.0,968.0&gt;-&lt;106.0,968.0&gt;&gt; has the same coordinates as a previous segment.

* uni0770.init: B&lt;&lt;124.0,512.0&gt;-&lt;124.0,512.0&gt;-&lt;124.0,512.0&gt;&gt; has the same coordinates as a previous segment.

* uni0770.init: B&lt;&lt;124.0,512.0&gt;-&lt;124.0,512.0&gt;-&lt;124.0,512.0&gt;&gt; has the same coordinates as a previous segment.

* uni0770.init: B&lt;&lt;124.0,512.0&gt;-&lt;124.0,512.0&gt;-&lt;124.0,512.0&gt;&gt; has the same coordinates as a previous segment.

* uni0770.init: B&lt;&lt;106.0,753.0&gt;-&lt;106.0,753.0&gt;-&lt;106.0,753.0&gt;&gt; has the same coordinates as a previous segment.
...
* uni077D (U+077D): B&lt;&lt;1407.0,1236.0&gt;-&lt;1407.0,1236.0&gt;-&lt;1407.0,1236.0&gt;&gt; has the same coordinates as a previous segment.

* uni077D (U+077D): B&lt;&lt;1406.0,1229.0&gt;-&lt;1407.0,1229.0&gt;-&lt;1409.0,1229.0&gt;&gt; has the same coordinates as a previous segment.

* uni077D.fina: B&lt;&lt;545.0,1236.0&gt;-&lt;545.0,1236.0&gt;-&lt;545.0,1236.0&gt;&gt; has the same coordinates as a previous segment.

* uni077D.fina: B&lt;&lt;544.0,1229.0&gt;-&lt;545.0,1229.0&gt;-&lt;547.0,1229.0&gt;&gt; has the same coordinates as a previous segment.

* uni077D.init: B&lt;&lt;796.0,1236.0&gt;-&lt;796.0,1236.0&gt;-&lt;796.0,1236.0&gt;&gt; has the same coordinates as a previous segment.

* uni077D.init: B&lt;&lt;795.0,1229.0&gt;-&lt;796.0,1229.0&gt;-&lt;798.0,1229.0&gt;&gt; has the same coordinates as a previous segment.

* uni077D.medi: B&lt;&lt;684.0,1236.0&gt;-&lt;684.0,1236.0&gt;-&lt;684.0,1236.0&gt;&gt; has the same coordinates as a previous segment.

* uni077D.medi: B&lt;&lt;682.0,1229.0&gt;-&lt;683.0,1229.0&gt;-&lt;685.0,1229.0&gt;&gt; has the same coordinates as a previous segment.

* uni08DB (U+08DB): L&lt;&lt;160.0,1010.0&gt;--&lt;160.0,1010.0&gt;&gt; has the same coordinates as a previous segment.
</code></pre>
...
<pre><code>- Contour 3 start point differs in glyph 'uni20A6' between location wght=400 and location wght=700
...
- Contour 14 start point differs in glyph 'uniFDFD' between location wght=400 and location wght=700
...
<li>U+0307 COMBINING DOT ABOVE: try adding one of: malayalam, tai-le, hebrew, tifinagh, todhri, math, syriac, coptic, old-permic, duployan, canadian-aboriginal</li>
...
<li>U+0331 COMBINING MACRON BELOW: try adding one of: gothic, cherokee, tifinagh, thai, syriac, sunuwar, caucasian-albanian</li>
...
<li>U+060C ARABIC COMMA: try adding one of: thaana, syriac, hanifi-rohingya, garay, yezidi, nko, arabic</li>
...
<li>U+061B ARABIC SEMICOLON: try adding one of: thaana, syriac, hanifi-rohingya, garay, yezidi, nko, arabic</li>
...
<li>U+061F ARABIC QUESTION MARK: try adding one of: adlam, thaana, hanifi-rohingya, syriac, garay, yezidi, nko, arabic</li>
...
<li>U+0640 ARABIC TATWEEL: try adding one of: sogdian, psalter-pahlavi, adlam, mandaic, old-uyghur, manichaean, hanifi-rohingya, syriac, arabic</li>
...
<li>U+0660 ARABIC-INDIC DIGIT ZERO: try adding one of: indic-siyaq-numbers, thaana, syriac, hanifi-rohingya, yezidi, arabic</li>
<li>U+0661 ARABIC-INDIC DIGIT ONE: try adding one of: indic-siyaq-numbers, thaana, syriac, yezidi, arabic</li>
<li>U+0662 ARABIC-INDIC DIGIT TWO: try adding one of: indic-siyaq-numbers, thaana, syriac, yezidi, arabic</li>
<li>U+0663 ARABIC-INDIC DIGIT THREE: try adding one of: indic-siyaq-numbers, thaana, syriac, yezidi, arabic</li>
<li>U+0664 ARABIC-INDIC DIGIT FOUR: try adding one of: indic-siyaq-numbers, thaana, syriac, yezidi, arabic</li>
<li>U+0665 ARABIC-INDIC DIGIT FIVE: try adding one of: indic-siyaq-numbers, thaana, syriac, yezidi, arabic</li>
<li>U+0666 ARABIC-INDIC DIGIT SIX: try adding one of: indic-siyaq-numbers, thaana, syriac, yezidi, arabic</li>
<li>U+0667 ARABIC-INDIC DIGIT SEVEN: try adding one of: indic-siyaq-numbers, thaana, syriac, yezidi, arabic</li>
<li>U+0668 ARABIC-INDIC DIGIT EIGHT: try adding one of: indic-siyaq-numbers, thaana, syriac, yezidi, arabic</li>
<li>U+0669 ARABIC-INDIC DIGIT NINE: try adding one of: indic-siyaq-numbers, thaana, syriac, yezidi, arabic</li>
...
<li>U+200C ZERO WIDTH NON-JOINER: try adding one of: buhid, hanunoo, tibetan, limbu, tai-tham, pahawh-hmong, modi, sundanese, syloti-nagri, dogra, sinhala, gujarati, oriya, manichaean, syriac, lepcha, rejang, bengali, batak, buginese, khudawadi, tamil, malayalam, newa, tirhuta, tai-le, myanmar, mandaic, takri, khmer, brahmi, cham, tagbanwa, devanagari, hatran, grantha, avestan, telugu, bhaiksuki, zanabazar-square, sogdian, mongolian, psalter-pahlavi, tai-viet, balinese, tifinagh, tagalog, javanese, thai, yi, masaram-gondi, phags-pa, hanifi-rohingya, lao, kayah-li, meetei-mayek, arabic, kaithi, warang-citi, mahajani, chakma, gurmukhi, new-tai-lue, saurashtra, hebrew, siddham, gunjala-gondi, khojki, kannada, thaana, kharoshthi, sharada, duployan, nko</li>
<li>U+200D ZERO WIDTH JOINER: try adding one of: buhid, hanunoo, tibetan, limbu, tai-tham, pahawh-hmong, modi, sundanese, syloti-nagri, dogra, sinhala, gujarati, oriya, manichaean, syriac, lepcha, rejang, bengali, batak, buginese, khudawadi, tamil, malayalam, newa, tirhuta, tai-le, myanmar, mandaic, takri, khmer, brahmi, cham, tagbanwa, devanagari, old-hungarian, grantha, avestan, telugu, bhaiksuki, zanabazar-square, sogdian, mongolian, psalter-pahlavi, tai-viet, balinese, tifinagh, tagalog, javanese, thai, yi, masaram-gondi, phags-pa, hanifi-rohingya, lao, kayah-li, meetei-mayek, arabic, kaithi, warang-citi, mahajani, chakma, gurmukhi, new-tai-lue, saurashtra, hebrew, siddham, gunjala-gondi, khojki, kannada, thaana, kharoshthi, sharada, duployan, nko</li>
<li>U+200E LEFT-TO-RIGHT MARK: try adding one of: hebrew, thaana, phags-pa, syriac, nko, arabic</li>
<li>U+200F RIGHT-TO-LEFT MARK: try adding one of: hebrew, thaana, phags-pa, syriac, nko</li>
<li>U+2010 HYPHEN: try adding one of: kayah-li, armenian, sora-sompeng, hebrew, sundanese, syloti-nagri, yi, cham, kharoshthi, coptic, lisu, arabic, kaithi</li>
...
<li>U+25CC DOTTED CIRCLE: try adding one of: symbols, tai-tham, modi, bassa-vah, math, oriya, lepcha, miao, khudawadi, tirhuta, brahmi, coptic, grantha, marchen, sogdian, tai-viet, tifinagh, kaithi, ahom, saurashtra, khojki, kannada, takri, tibetan, sundanese, manichaean, music, myanmar, khmer, wancho, adlam, thai, phags-pa, warang-citi, mahajani, new-tai-lue, hebrew, gunjala-gondi, thaana, elbasan, kharoshthi, sharada, limbu, pahawh-hmong, dogra, syriac, rejang, canadian-aboriginal, tamil, armenian, malayalam, newa, tai-le, mandaic, tagbanwa, devanagari, telugu, bhaiksuki, psalter-pahlavi, tagalog, javanese, hanifi-rohingya, mende-kikakui, chakma, gurmukhi, duployan, nko, buhid, hanunoo, syloti-nagri, sinhala, gujarati, bengali, batak, buginese, soyombo, cham, old-permic, zanabazar-square, mongolian, balinese, yi, masaram-gondi, osage, lao, kayah-li, meetei-mayek, siddham, caucasian-albanian</li>
...
<pre><code>* uni08DA (U+08DA) has a counter-clockwise outer contour

* uni08DD (U+08DD) has a counter-clockwise outer contour

* uni08E1 (U+08E1) has a counter-clockwise outer contour
</code></pre>
...
<details><summary>[17] QalamBadi-Italic[wght].ttf</summary>
<div>
<details>
    <summary>🔥 <b>FAIL</b> Check base characters have non-zero advance width. <a href="https://fontbakery.readthedocs.io/en/stable/fontbakery/checks/universal.html#base-has-width">base_has_width</a></summary>
    <div>
...
* uni0770.init: B&lt;&lt;252.0,727.5&gt;-&lt;252.0,727.0&gt;-&lt;252.0,727.0&gt;&gt; has the same coordinates as a previous segment.

* uni0770.init: B&lt;&lt;277.0,968.0&gt;-&lt;277.0,968.0&gt;-&lt;277.0,968.0&gt;&gt; has the same coordinates as a previous segment.

* uni0770.init: B&lt;&lt;277.0,968.0&gt;-&lt;277.0,968.0&gt;-&lt;277.0,968.0&gt;&gt; has the same coordinates as a previous segment.

* uni0770.init: B&lt;&lt;277.0,968.0&gt;-&lt;277.0,968.0&gt;-&lt;277.0,968.0&gt;&gt; has the same coordinates as a previous segment.

* uni0770.init: B&lt;&lt;214.0,512.0&gt;-&lt;214.0,512.0&gt;-&lt;214.0,512.0&gt;&gt; has the same coordinates as a previous segment.

* uni0770.init: B&lt;&lt;214.0,512.0&gt;-&lt;214.0,512.0&gt;-&lt;214.0,512.0&gt;&gt; has the same coordinates as a previous segment.

* uni0770.init: B&lt;&lt;214.0,512.0&gt;-&lt;214.0,512.0&gt;-&lt;214.0,512.0&gt;&gt; has the same coordinates as a previous segment.

* uni0770.init: B&lt;&lt;239.0,753.0&gt;-&lt;239.0,753.0&gt;-&lt;239.0,753.0&gt;&gt; has the same coordinates as a previous segment.
...
* uni077D (U+077D): B&lt;&lt;1625.0,1236.0&gt;-&lt;1625.0,1236.0&gt;-&lt;1625.0,1236.0&gt;&gt; has the same coordinates as a previous segment.

* uni077D.fina: B&lt;&lt;763.0,1236.0&gt;-&lt;763.0,1236.0&gt;-&lt;763.0,1236.0&gt;&gt; has the same coordinates as a previous segment.

* uni077D.init: B&lt;&lt;1014.0,1236.0&gt;-&lt;1014.0,1236.0&gt;-&lt;1014.0,1236.0&gt;&gt; has the same coordinates as a previous segment.

* uni077D.medi: B&lt;&lt;902.0,1236.0&gt;-&lt;902.0,1236.0&gt;-&lt;902.0,1236.0&gt;&gt; has the same coordinates as a previous segment.

* uni08DB (U+08DB): L&lt;&lt;338.0,1010.0&gt;--&lt;338.0,1010.0&gt;&gt; has the same coordinates as a previous segment.
</code></pre>
 [code: overlapping-path-segments]
